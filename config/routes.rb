Rails.application.routes.draw do
  ...
  post '/:entity_type/new', to: 'entities#update'
  ...
  get '/:entity_type/:entity_id/collection/:collection/new', to: 'entities#collection_insert'
  post '/:entity_type/:entity_id/collection/:collection/new', to: 'entities#collection_insert_save'
